CREATE Procedure [dbo].[rpt_Cases1]
(
 @DateFrom Datetime,
 @DateTo Datetime,
 @StatusID Int,
...
--exec rpt_Cases1 @DateFrom='2016-04-13 00:00:00',@DateTo='2016-05-13 00:00:00',@StatusID=5,@FacilityID=1,@CaseType=NULL,@Type=NULL,@WorkerID=NULL,@Eligible=NULL
